...
class AlgorithmSettings{
	...
	public function __construct(protected int $jumpHeight = 1, protected int $fallDistance = 2, protected float $timeout = 0.05, protected int $maxTicks = 0, protected bool $onlyAcceptFullPath = false, ?CostCalculator $costCalculator = null, ?Validator $validator = null){
